...
export const LogoBlu: React.FC<{ width?: number }> = ({ width = 380 }) => {
  const height = Math.round(width * 1306.5 / 2000);
  return (
    <div style={{ filter: "drop-shadow(0 0 8px rgba(0,207,206,0.25))" }}>
      <svg viewBox="0 0 2000 1306.5" width={width} height={height} xmlns="http://www.w3.org/2000/svg">
